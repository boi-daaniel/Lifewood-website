...
export const Innovation: React.FC = () => {
    return (
        <section id="innovation" className="py-24 bg-brand-cream dark:bg-brand-green transition-colors duration-300 overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    {/* Card 1 */}
                    <div className="relative group rounded-3xl overflow-hidden h-[400px] cursor-pointer hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(16,79,56,0.3)] hover:ring-1 hover:ring-white/20 transition-all duration-300 ease-out">
                        <img 
                    ...
                    {/* Card 2 */}
                    <div className="relative group rounded-3xl overflow-hidden h-[400px] mt-12 md:mt-0 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(16,79,56,0.3)] hover:ring-1 hover:ring-white/20 transition-all duration-300 ease-out">
                         <img 
                        ...
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 via-black/40 to-transparent p-8 flex flex-col justify-between">
                            <div></div>
                            <div>
                                <h3 className="text-3xl font-bold text-white mb-2">Expertise +</h3>
                                <p className="text-gray-300 text-sm translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
