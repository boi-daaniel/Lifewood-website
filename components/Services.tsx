...
export const Services: React.FC = () => {
    return (
        <section className="py-24 bg-brand-cream dark:bg-brand-green transition-colors duration-300" id="services">
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">AI Data Services</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
                    ...
                    {/* Audio - Wide Top Left */}
                    <div className="md:col-span-2 relative group rounded-3xl overflow-hidden h-[300px] md:h-auto bg-gray-900 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(16,79,56,0.3)] hover:ring-1 hover:ring-white/20 transition-all duration-300 ease-out">
                        ...
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-black/80 to-transparent p-8 flex flex-col justify-between">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-2">Audio Intelligence</h3>
                                <p className="text-gray-300 text-sm max-w-sm translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                    ...
                    <div className="md:col-span-1 md:row-span-2 relative group rounded-3xl overflow-hidden h-[400px] md:h-auto bg-gray-900 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(16,79,56,0.3)] hover:ring-1 hover:ring-white/20 transition-all duration-300 ease-out">
                        <img src="https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-40 group-hover:scale-105 transition-all duration-700" alt="Text" />
                         <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 via-black/40 to-transparent p-8 flex flex-col justify-between">
                             <div className="bg-white/10 w-fit p-3 rounded-xl backdrop-blur-sm group-hover:bg-brand-green/80 group-hover:scale-110 transition-all duration-300">
                                <FileText className="text-white" size={24} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-2">NLP & Text</h3>
                                <p className="text-gray-300 text-sm translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                    ...
                    {/* Image - Bottom Left */}
                    <div className="relative group rounded-3xl overflow-hidden h-[300px] md:h-auto bg-gray-900 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(16,79,56,0.3)] hover:ring-1 hover:ring-white/20 transition-all duration-300 ease-out">
                        ...
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-black/80 to-transparent p-8 flex flex-col justify-between">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-2">Computer Vision</h3>
                                <p className="text-gray-300 text-sm translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                    ...
                    <div className="relative group rounded-3xl overflow-hidden h-[300px] md:h-auto bg-gray-900 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(16,79,56,0.3)] hover:ring-1 hover:ring-white/20 transition-all duration-300 ease-out">
                        ...
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-black/80 to-transparent p-8 flex flex-col justify-between">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-2">Video Analytics</h3>
                                <p className="text-gray-300 text-sm translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
